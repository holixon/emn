...
- Example: *User clicks “Place Order” → “PlaceOrder” Command → “OrderPlaced” Event*
...
- Example: *“OrderPlaced” + “PaymentReceived” Events → “Order Payment” Query → “Order Status” View*
...
- Example: *“OrderPlaced” Event → Auto-Trigger → “SendConfirmationEmail” Command → “ConfirmationSent” Event*

## Translation Pattern

**Event(s) (source system) → View → Automated Trigger → Command → Event(s) (target system)**
...
- Example: *“InvoiceCreated” Event from System A → View → Auto-Trigger → “SyncInvoice” Command → “InvoiceSynced” Event in System B*
